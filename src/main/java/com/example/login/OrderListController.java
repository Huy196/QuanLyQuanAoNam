...
import com.example.login.OrderItemController;
    ...
    private void initialize() {
        ...
        orders = FXCollections.observableArrayList(
                ...
                new Order(new Customer("KhanhBaoNguyen", "khanhbaonguyen@gmail.com"),
                        ...
                        3, "Đã thanh toán"),
                new Order(new Customer("ThomNgocPham", "thomngocpham@gmail.com"),
                        new Product("Sản phẩm E", 95.000, 100, null),
                        7, "Hủy đơn"),
                new Order(new Customer("MinhTuanNguyen", "minhtuannguyen@gmail.com"),
